...
const artisans = [
    ...
    {id:7, name:"Jean-Pierre Bemba", category:"Électricien", rating:4.6, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:20, distance:4, price:"moyen"},
    {id:8, name:"Sophie Kanza", category:"Plombier", rating:4.3, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:11, distance:7, price:"budget"},
    {id:9, name:"Marc Kabeya", category:"Menuisier", rating:4.0, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:9, distance:3, price:"premium"},
    {id:10, name:"Isabelle Mutombo", category:"Peintre", rating:4.4, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:14, distance:5, price:"moyen"},
    {id:11, name:"Fabrice Mbuyi", category:"Mécanicien", rating:4.9, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:22, distance:6, price:"premium"},
    {id:12, name:"Clara Kitenge", category:"Maçon", rating:3.8, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:4, distance:10, price:"budget"},
    {id:13, name:"David Ngoma", category:"Électricien", rating:4.2, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:13, distance:2, price:"moyen"},
    {id:14, name:"Emilie Mbuyamba", category:"Plombier", rating:4.5, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:15, distance:8, price:"premium"},
    {id:15, name:"Hervé Liyongo", category:"Menuisier", rating:3.9, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:6, distance:7, price:"budget"},
    {id:16, name:"Josiane Kasongo", category:"Peintre", rating:4.1, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:10, distance:5, price:"moyen"},
    {id:17, name:"Olivier Kabemba", category:"Mécanicien", rating:4.6, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:18, distance:3, price:"moyen"},
    {id:18, name:"Sandra Kambale", category:"Maçon", rating:4.0, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:7, distance:9, price:"premium"},
    {id:19, name:"Benoît Mukeba", category:"Électricien", rating:4.7, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:19, distance:4, price:"premium"},
    {id:20, name:"Alice Kabongo", category:"Plombier", rating:4.3, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:12, distance:6, price:"moyen"},
    {id:21, name:"Christian Kabuya", category:"Menuisier", rating:4.1, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:8, distance:5, price:"budget"},
    {id:22, name:"Véronique Mbala", category:"Peintre", rating:4.5, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:17, distance:3, price:"premium"},
    {id:23, name:"Félix Mukeba", category:"Mécanicien", rating:4.2, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:11, distance:7, price:"moyen"},
    {id:24, name:"Christine Mbuyi", category:"Maçon", rating:3.9, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:5, distance:8, price:"budget"},
    {id:25, name:"Jonathan Kalala", category:"Électricien", rating:4.6, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:16, distance:2, price:"moyen"},
    {id:26, name:"Nathalie Tshibanda", category:"Plombier", rating:4.0, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:9, distance:5, price:"budget"},
    {id:27, name:"Emmanuel Kitenge", category:"Menuisier", rating:4.4, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:14, distance:6, price:"premium"},
    {id:28, name:"Jessica Kasongo", category:"Peintre", rating:3.8, availability:"Occupé", photo:"https://via.placeholder.com/100", reviews:4, distance:7, price:"budget"},
    {id:29, name:"André Kalombo", category:"Mécanicien", rating:4.7, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:20, distance:3, price:"premium"},
    {id:30, name:"Carine Mbemba", category:"Maçon", rating:4.1, availability:"Disponible", photo:"https://via.placeholder.com/100", reviews:10, distance:5, price:"moyen"}
];
